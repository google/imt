...
#include "stanExports_hurdlelognormal.h"

RCPP_MODULE(stan_fit4hurdlelognormal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_hurdlelognormal")
